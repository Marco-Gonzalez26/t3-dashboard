...
const DescriptionList: React.FC<{ patient?: Paciente | null | undefined }> = ({
  ...
  return (
    <div className=" mt-5 h-full overflow-hidden bg-white shadow-xl  sm:rounded-lg">
      ...
      <div className="flex border-t border-gray-200 ">
        <dl>
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm uppercase text-gray-900 sm:col-span-2 sm:mt-0">
              {patient?.nombre}
            </dd>
          </div>
          ...
          <div className="bg-white px-4 py-5  sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm uppercase text-gray-900 sm:col-span-2 sm:mt-0">
              {patient?.ttoActual || "No hay promedio"}
            </dd>
          </div>
        </dl>
        <dl>
          ...
          <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              {patient?.primeraCita?.toLocaleDateString()}
            </dd>
          </div>
          <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
            <dt className="text-sm font-medium text-gray-500">
            ...
            <dd className="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              {patient?.control?.toLocaleDateString()}
            </dd>
          </div>
        </dl>
      </div>
